...
<html>
	<head>
		<title>modificacion by david</title>
	...
	<!-- Header -->
		<div id="header">
			<div class="container">
				...
				<!-- Logo -->
					<div id="logo">
						<h1><a href="#">Perfil Profecional</a></h1>
					</div>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							...
							if ($_SESSION['Nombre'] == "") {
								?>
								<li><a href="secion.html">Iniciar secion</a></li>
								<?php
							}else{
								?>
								<li class="inicio"><a href="perfil.php"><?php echo $_SESSION['Nombre'] ?></a></li>
								<li><a href="destroyer.php">cerrar Session</a></li>
								<?php
							}
				...
				<div class="row">
					<div class="3u">
						<section>
							...
							<p><a href="#"><img src="images/base.jpg" alt=""></a></p>
					...
					<div class="3u">
						<section>
							...
							<p class="subtitle">In posuere eleifend odio. Quisque semper augue mattis maecenas ligula.</p>
							<p><a href="#"><img src="images/base2.jpg" alt=""></a></p>
							<a href="#" class="button">More</a>
						</section>
					</div>
					<div class="3u">
						<section>
							...
							<p class="subtitle">In posuere eleifend odio. Quisque semper augue mattis maecenas ligula.</p>
							<p><a href="#"><img src="images/base3.jpg" alt=""></a></p>
							<a href="#" class="button">More</a>
						</section>
					</div>
					<div class="3u">
						<section>
							...
							<p class="subtitle">In posuere eleifend odio. Quisque semper augue mattis maecenas ligula.</p>
							<p><a href="#"><img src="images/base4.jpg" alt=""></a></p>
							<a href="#" class="button">More</a>
						</section>
					</div>
				</div>
		...
		<div id="featured">
			<div class="container">
				<div class="row">
					<section class="4u">
						<div class="box">
							<a href="#" class="image left"><img src="images/base.jpg" alt=""></a>
					...
					<section class="4u">
						<div class="box">
							<a href="#" class="image left"><img src="images/base2.jpg" alt=""></a>
							<h3>Etiam posuere augue</h3>
							<p>Donec nonummy magna quis risus eleifend. </p>
							<a href="#" class="button">More</a>
						</div>
					...
					<section class="4u">
						<div class="box">
							<a href="#" class="image left"><img src="images/base3.jpg" alt=""></a>
							<h3>Etiam posuere augue</h3>
							<p>Donec nonummy magna quis risus eleifend. </p>
							<a href="#" class="button">More</a>
						</div>
